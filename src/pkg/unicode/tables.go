...
// Version 为得到此表所用的Unicode版本。
const Version = "6.3.0"

// Categories 为Unicode类别表的集合。
...
// 这些变量的类型为 *RangeTable。
var (
	Cc     = _Cc // Cc 为类别 Cc 中的Unicode字符集合。
	Cf     = _Cf // Cf 为类别 Cf 中的Unicode字符集合。
	Co     = _Co // Co 为类别 Co 中的Unicode字符集合。
	Cs     = _Cs // Cs 为类别 Cs 中的Unicode字符集合。
	Digit  = _Nd // Digit 为带属性“十进制数字”的Unicode字符集合。
	Nd     = _Nd // Nd 为类别 Nd 中的Unicode字符集合。
	Letter = _L  // Letter/L 为类别 L 中的Unicode字母字符集合。
	L      = _L
	Lm     = _Lm // Lm 为类别 Lm 中的Unicode字符集合。
	Lo     = _Lo // Lo 为类别 Lo 中的Unicode字符集合。
	Lower  = _Ll // Lower 为Unicode小写字母集合。
	Ll     = _Ll // Ll 为类别 Ll 中的Unicode字符集合。
	Mark   = _M  // Mark/M 为类别 M 中的Unicode标记字符集合。
	M      = _M
	Mc     = _Mc // Mc 为类别 Mc 中的Unicode字符集合。
	Me     = _Me // Me 为类别 Me 中的Unicode字符集合。
	Mn     = _Mn // Mn 为类别 Mn 中的Unicode字符集合。
	Nl     = _Nl // Nl 为类别 Nl 中的Unicode字符集合。
	No     = _No // No 为类别 No 中的Unicode字符集合。
	Number = _N  // Number/N 为类别 N 中的Unicode数字字符集合。
	N      = _N
	Other  = _C // Other/C 为类别 C 中的Unicode控制和特殊字符集合。
	C      = _C
	Pc     = _Pc // Pc 为类别 Pc 中的Unicode字符集合。
	Pd     = _Pd // Pd 为类别 Pd 中的Unicode字符集合。
	Pe     = _Pe // Pe 为类别 Pe 中的Unicode字符集合。
	Pf     = _Pf // Pf 为类别 Pf 中的Unicode字符集合。
	Pi     = _Pi // Pi 为类别 Pi 中的Unicode字符集合。
	Po     = _Po // Po 为类别 Po 中的Unicode字符集合。
	Ps     = _Ps // Ps 为类别 Ps 中的Unicode字符集合。
	Punct  = _P  // Punct/P 为类别 P 中的Unicode标点字符集合。
	P      = _P
	Sc     = _Sc // Sc 为类别 Sc 中的Unicode字符集合。
	Sk     = _Sk // Sk 为类别 Sk 中的Unicode字符集合。
	Sm     = _Sm // Sm 为类别 Sm 中的Unicode字符集合。
	So     = _So // So 为类别 So 中的Unicode字符集合。
	Space  = _Z  // Space/Z 为类别 Z 中的Unicode空白字符集合。
	Z      = _Z
	Symbol = _S // Symbol/S 为类别 S 中的Unicode符号字符集合。
	S      = _S
	Title  = _Lt // Title 为Unicode标题字母集合。
	Lt     = _Lt // Lt 为类别 Lt 中的Unicode字符集合。
	Upper  = _Lu // Upper 为Unicode大写字母集合。
	Lu     = _Lu // Lu 为类别 Lu 中的Unicode字符集合。
	Zl     = _Zl // Zl 为类别 Zl 中的Unicode字符集合。
	Zp     = _Zp // Zp 为类别 Zp 中的Unicode字符集合。
	Zs     = _Zs // Zs 为类别 Zs 中的Unicode字符集合。
)
...
// 这些变量的类型为 *RangeTable。
var (
	Arabic                 = _Arabic                 // Arabic 为书写系统 Arabic 中的Unicode字符集合。
	Armenian               = _Armenian               // Armenian 为书写系统 Armenian 中的Unicode字符集合。
	Avestan                = _Avestan                // Avestan 为书写系统 Avestan 中的Unicode字符集合。
	Balinese               = _Balinese               // Balinese 为书写系统 Balinese 中的Unicode字符集合。
	Bamum                  = _Bamum                  // Bamum 为书写系统 Bamum 中的Unicode字符集合。
	Batak                  = _Batak                  // Batak 为书写系统 Batak 中的Unicode字符集合。
	Bengali                = _Bengali                // Bengali 为书写系统 Bengali 中的Unicode字符集合。
	Bopomofo               = _Bopomofo               // Bopomofo 为书写系统 Bopomofo 中的Unicode字符集合。
	Brahmi                 = _Brahmi                 // Brahmi 为书写系统 Brahmi 中的Unicode字符集合。
	Braille                = _Braille                // Braille 为书写系统 Braille 中的Unicode字符集合。
	Buginese               = _Buginese               // Buginese 为书写系统 Buginese 中的Unicode字符集合。
	Buhid                  = _Buhid                  // Buhid 为书写系统 Buhid 中的Unicode字符集合。
	Canadian_Aboriginal    = _Canadian_Aboriginal    // Canadian_Aboriginal 为书写系统 Canadian_Aboriginal 中的Unicode字符集合。
	Carian                 = _Carian                 // Carian 为书写系统 Carian 中的Unicode字符集合。
	Chakma                 = _Chakma                 // Chakma 为书写系统 Chakma 中的Unicode字符集合。
	Cham                   = _Cham                   // Cham 为书写系统 Cham 中的Unicode字符集合。
	Cherokee               = _Cherokee               // Cherokee 为书写系统 Cherokee 中的Unicode字符集合。
	Common                 = _Common                 // Common 为书写系统 Common 中的Unicode字符集合。
	Coptic                 = _Coptic                 // Coptic 为书写系统 Coptic 中的Unicode字符集合。
	Cuneiform              = _Cuneiform              // Cuneiform 为书写系统 Cuneiform 中的Unicode字符集合。
	Cypriot                = _Cypriot                // Cypriot 为书写系统 Cypriot 中的Unicode字符集合。
	Cyrillic               = _Cyrillic               // Cyrillic 为书写系统 Cyrillic 中的Unicode字符集合。
	Deseret                = _Deseret                // Deseret 为书写系统 Deseret 中的Unicode字符集合。
	Devanagari             = _Devanagari             // Devanagari 为书写系统 Devanagari 中的Unicode字符集合。
	Egyptian_Hieroglyphs   = _Egyptian_Hieroglyphs   // Egyptian_Hieroglyphs 为书写系统 Egyptian_Hieroglyphs 中的Unicode字符集合。
	Ethiopic               = _Ethiopic               // Ethiopic 为书写系统 Ethiopic 中的Unicode字符集合。
	Georgian               = _Georgian               // Georgian 为书写系统 Georgian 中的Unicode字符集合。
	Glagolitic             = _Glagolitic             // Glagolitic 为书写系统 Glagolitic 中的Unicode字符集合。
	Gothic                 = _Gothic                 // Gothic 为书写系统 Gothic 中的Unicode字符集合。
	Greek                  = _Greek                  // Greek 为书写系统 Greek 中的Unicode字符集合。
	Gujarati               = _Gujarati               // Gujarati 为书写系统 Gujarati 中的Unicode字符集合。
	Gurmukhi               = _Gurmukhi               // Gurmukhi 为书写系统 Gurmukhi 中的Unicode字符集合。
	Han                    = _Han                    // Han 为书写系统 Han 中的Unicode字符集合。
	Hangul                 = _Hangul                 // Hangul 为书写系统 Hangul 中的Unicode字符集合。
	Hanunoo                = _Hanunoo                // Hanunoo 为书写系统 Hanunoo 中的Unicode字符集合。
	Hebrew                 = _Hebrew                 // Hebrew 为书写系统 Hebrew 中的Unicode字符集合。
	Hiragana               = _Hiragana               // Hiragana 为书写系统 Hiragana 中的Unicode字符集合。
	Imperial_Aramaic       = _Imperial_Aramaic       // Imperial_Aramaic 为书写系统 Imperial_Aramaic 中的Unicode字符集合。
	Inherited              = _Inherited              // Inherited 为书写系统 Inherited 中的Unicode字符集合。
	Inscriptional_Pahlavi  = _Inscriptional_Pahlavi  // Inscriptional_Pahlavi 为书写系统 Inscriptional_Pahlavi 中的Unicode字符集合。
	Inscriptional_Parthian = _Inscriptional_Parthian // Inscriptional_Parthian 为书写系统 Inscriptional_Parthian 中的Unicode字符集合。
	Javanese               = _Javanese               // Javanese 为书写系统 Javanese 中的Unicode字符集合。
	Kaithi                 = _Kaithi                 // Kaithi 为书写系统 Kaithi 中的Unicode字符集合。
	Kannada                = _Kannada                // Kannada 为书写系统 Kannada 中的Unicode字符集合。
	Katakana               = _Katakana               // Katakana 为书写系统 Katakana 中的Unicode字符集合。
	Kayah_Li               = _Kayah_Li               // Kayah_Li 为书写系统 Kayah_Li 中的Unicode字符集合。
	Kharoshthi             = _Kharoshthi             // Kharoshthi 为书写系统 Kharoshthi 中的Unicode字符集合。
	Khmer                  = _Khmer                  // Khmer 为书写系统 Khmer 中的Unicode字符集合。
	Lao                    = _Lao                    // Lao 为书写系统 Lao 中的Unicode字符集合。
	Latin                  = _Latin                  // Latin 为书写系统 Latin 中的Unicode字符集合。
	Lepcha                 = _Lepcha                 // Lepcha 为书写系统 Lepcha 中的Unicode字符集合。
	Limbu                  = _Limbu                  // Limbu 为书写系统 Limbu 中的Unicode字符集合。
	Linear_B               = _Linear_B               // Linear_B 为书写系统 Linear_B 中的Unicode字符集合。
	Lisu                   = _Lisu                   // Lisu 为书写系统 Lisu 中的Unicode字符集合。
	Lycian                 = _Lycian                 // Lycian 为书写系统 Lycian 中的Unicode字符集合。
	Lydian                 = _Lydian                 // Lydian 为书写系统 Lydian 中的Unicode字符集合。
	Malayalam              = _Malayalam              // Malayalam 为书写系统 Malayalam 中的Unicode字符集合。
	Mandaic                = _Mandaic                // Mandaic 为书写系统 Mandaic 中的Unicode字符集合。
	Meetei_Mayek           = _Meetei_Mayek           // Meetei_Mayek 为书写系统 Meetei_Mayek 中的Unicode字符集合。
	Meroitic_Cursive       = _Meroitic_Cursive       // Meroitic_Cursive 为书写系统 Meroitic_Cursive 中的Unicode字符集合。
	Meroitic_Hieroglyphs   = _Meroitic_Hieroglyphs   // Meroitic_Hieroglyphs 为书写系统 Meroitic_Hieroglyphs 中的Unicode字符集合。
	Miao                   = _Miao                   // Miao 为书写系统 Miao 中的Unicode字符集合。
	Mongolian              = _Mongolian              // Mongolian 为书写系统 Mongolian 中的Unicode字符集合。
	Myanmar                = _Myanmar                // Myanmar 为书写系统 Myanmar 中的Unicode字符集合。
	New_Tai_Lue            = _New_Tai_Lue            // New_Tai_Lue 为书写系统 New_Tai_Lue 中的Unicode字符集合。
	Nko                    = _Nko                    // Nko 为书写系统 Nko 中的Unicode字符集合。
	Ogham                  = _Ogham                  // Ogham 为书写系统 Ogham 中的Unicode字符集合。
	Ol_Chiki               = _Ol_Chiki               // Ol_Chiki 为书写系统 Ol_Chiki 中的Unicode字符集合。
	Old_Italic             = _Old_Italic             // Old_Italic 为书写系统 Old_Italic 中的Unicode字符集合。
	Old_Persian            = _Old_Persian            // Old_Persian 为书写系统 Old_Persian 中的Unicode字符集合。
	Old_South_Arabian      = _Old_South_Arabian      // Old_South_Arabian 为书写系统 Old_South_Arabian 中的Unicode字符集合。
	Old_Turkic             = _Old_Turkic             // Old_Turkic 为书写系统 Old_Turkic 中的Unicode字符集合。
	Oriya                  = _Oriya                  // Oriya 为书写系统 Oriya 中的Unicode字符集合。
	Osmanya                = _Osmanya                // Osmanya 为书写系统 Osmanya 中的Unicode字符集合。
	Phags_Pa               = _Phags_Pa               // Phags_Pa 为书写系统 Phags_Pa 中的Unicode字符集合。
	Phoenician             = _Phoenician             // Phoenician 为书写系统 Phoenician 中的Unicode字符集合。
	Rejang                 = _Rejang                 // Rejang 为书写系统 Rejang 中的Unicode字符集合。
	Runic                  = _Runic                  // Runic 为书写系统 Runic 中的Unicode字符集合。
	Samaritan              = _Samaritan              // Samaritan 为书写系统 Samaritan 中的Unicode字符集合。
	Saurashtra             = _Saurashtra             // Saurashtra 为书写系统 Saurashtra 中的Unicode字符集合。
	Sharada                = _Sharada                // Sharada 为书写系统 Sharada 中的Unicode字符集合。
	Shavian                = _Shavian                // Shavian 为书写系统 Shavian 中的Unicode字符集合。
	Sinhala                = _Sinhala                // Sinhala 为书写系统 Sinhala 中的Unicode字符集合。
	Sora_Sompeng           = _Sora_Sompeng           // Sora_Sompeng 为书写系统 Sora_Sompeng 中的Unicode字符集合。
	Sundanese              = _Sundanese              // Sundanese 为书写系统 Sundanese 中的Unicode字符集合。
	Syloti_Nagri           = _Syloti_Nagri           // Syloti_Nagri 为书写系统 Syloti_Nagri 中的Unicode字符集合。
	Syriac                 = _Syriac                 // Syriac 为书写系统 Syriac 中的Unicode字符集合。
	Tagalog                = _Tagalog                // Tagalog 为书写系统 Tagalog 中的Unicode字符集合。
	Tagbanwa               = _Tagbanwa               // Tagbanwa 为书写系统 Tagbanwa 中的Unicode字符集合。
	Tai_Le                 = _Tai_Le                 // Tai_Le 为书写系统 Tai_Le 中的Unicode字符集合。
	Tai_Tham               = _Tai_Tham               // Tai_Tham 为书写系统 Tai_Tham 中的Unicode字符集合。
	Tai_Viet               = _Tai_Viet               // Tai_Viet 为书写系统 Tai_Viet 中的Unicode字符集合。
	Takri                  = _Takri                  // Takri 为书写系统 Takri 中的Unicode字符集合。
	Tamil                  = _Tamil                  // Tamil 为书写系统 Tamil 中的Unicode字符集合。
	Telugu                 = _Telugu                 // Telugu 为书写系统 Telugu 中的Unicode字符集合。
	Thaana                 = _Thaana                 // Thaana 为书写系统 Thaana 中的Unicode字符集合。
	Thai                   = _Thai                   // Thai 为书写系统 Thai 中的Unicode字符集合。
	Tibetan                = _Tibetan                // Tibetan 为书写系统 Tibetan 中的Unicode字符集合。
	Tifinagh               = _Tifinagh               // Tifinagh 为书写系统 Tifinagh 中的Unicode字符集合。
	Ugaritic               = _Ugaritic               // Ugaritic 为书写系统 Ugaritic 中的Unicode字符集合。
	Vai                    = _Vai                    // Vai 为书写系统 Vai 中的Unicode字符集合。
	Yi                     = _Yi                     // Yi 为书写系统 Yi 中的Unicode字符集合。
)
...
// 这些变量的类型为 *RangeTable。
var (
	ASCII_Hex_Digit                    = _ASCII_Hex_Digit                    // ASCII_Hex_Digit 为带属性 ASCII_Hex_Digit 的Unicode字符集合。
	Bidi_Control                       = _Bidi_Control                       // Bidi_Control 为带属性 Bidi_Control 的Unicode字符集合。
	Dash                               = _Dash                               // Dash 为带属性 Dash 的Unicode字符集合。
	Deprecated                         = _Deprecated                         // Deprecated 为带属性 Deprecated 的Unicode字符集合。
	Diacritic                          = _Diacritic                          // Diacritic 为带属性 Diacritic 的Unicode字符集合。
	Extender                           = _Extender                           // Extender 为带属性 Extender 的Unicode字符集合。
	Hex_Digit                          = _Hex_Digit                          // Hex_Digit 为带属性 Hex_Digit 的Unicode字符集合。
	Hyphen                             = _Hyphen                             // Hyphen 为带属性 Hyphen 的Unicode字符集合。
	IDS_Binary_Operator                = _IDS_Binary_Operator                // IDS_Binary_Operator 为带属性 IDS_Binary_Operator 的Unicode字符集合。
	IDS_Trinary_Operator               = _IDS_Trinary_Operator               // IDS_Trinary_Operator 为带属性 IDS_Trinary_Operator 的Unicode字符集合。
	Ideographic                        = _Ideographic                        // Ideographic 为带属性 Ideographic 的Unicode字符集合。
	Join_Control                       = _Join_Control                       // Join_Control 为带属性 Join_Control 的Unicode字符集合。
	Logical_Order_Exception            = _Logical_Order_Exception            // Logical_Order_Exception 为带属性 Logical_Order_Exception 的Unicode字符集合。
	Noncharacter_Code_Point            = _Noncharacter_Code_Point            // Noncharacter_Code_Point 为带属性 Noncharacter_Code_Point 的Unicode字符集合。
	Other_Alphabetic                   = _Other_Alphabetic                   // Other_Alphabetic 为带属性 Other_Alphabetic 的Unicode字符集合。
	Other_Default_Ignorable_Code_Point = _Other_Default_Ignorable_Code_Point // Other_Default_Ignorable_Code_Point 为带属性 Other_Default_Ignorable_Code_Point 的Unicode字符集合。
	Other_Grapheme_Extend              = _Other_Grapheme_Extend              // Other_Grapheme_Extend 为带属性 Other_Grapheme_Extend 的Unicode字符集合。
	Other_ID_Continue                  = _Other_ID_Continue                  // Other_ID_Continue 为带属性 Other_ID_Continue 的Unicode字符集合。
	Other_ID_Start                     = _Other_ID_Start                     // Other_ID_Start 为带属性 Other_ID_Start 的Unicode字符集合。
	Other_Lowercase                    = _Other_Lowercase                    // Other_Lowercase 为带属性 Other_Lowercase 的Unicode字符集合。
	Other_Math                         = _Other_Math                         // Other_Math 为带属性 Other_Math 的Unicode字符集合。
	Other_Uppercase                    = _Other_Uppercase                    // Other_Uppercase 为带属性 Other_Uppercase 的Unicode字符集合。
	Pattern_Syntax                     = _Pattern_Syntax                     // Pattern_Syntax 为带属性 Pattern_Syntax 的Unicode字符集合。
	Pattern_White_Space                = _Pattern_White_Space                // Pattern_White_Space 为带属性 Pattern_White_Space 的Unicode字符集合。
	Quotation_Mark                     = _Quotation_Mark                     // Quotation_Mark 为带属性 Quotation_Mark 的Unicode字符集合。
	Radical                            = _Radical                            // Radical 为带属性 Radical 的Unicode字符集合。
	STerm                              = _STerm                              // STerm 为带属性 STerm 的Unicode字符集合。
	Soft_Dotted                        = _Soft_Dotted                        // Soft_Dotted 为带属性 Soft_Dotted 的Unicode字符集合。
	Terminal_Punctuation               = _Terminal_Punctuation               // Terminal_Punctuation 为带属性 Terminal_Punctuation 的Unicode字符集合。
	Unified_Ideograph                  = _Unified_Ideograph                  // Unified_Ideograph 为带属性 Unified_Ideograph 的Unicode字符集合。
	Variation_Selector                 = _Variation_Selector                 // Variation_Selector 为带属性 Variation_Selector 的Unicode字符集合。
	White_Space                        = _White_Space                        // White_Space 为带属性 White_Space 的Unicode字符集合。
)
...
// 范围条目数：3471 16-bit，832 32-bit，4303 总数。
// 范围字节数：20826 16-bit，9984 32-bit，30810 总数。
